extension PromptCatalog {
    static func asrQualityRules(inputLanguage: InputLanguage) -> String {
        ...
        case .auto:
            ...
            - 技术词、产品词和缩写优先按常见写法输出，例如 Utter、hotkey、menu bar、API、JSON、i18n、URL
        ...
        case .english:
            ...
            - Prefer standard spelling for product names, technical terms, and acronyms, such as Utter, hotkey, menu bar, API, JSON, i18n, and URL
        ...
        case .japanese:
            ...
            - 製品名、技術語、略語は Utter、hotkey、menu bar、API、JSON、i18n、URL のような標準表記を優先する
        ...
        case .korean:
            ...
            - 제품명, 기술 용어, 약어는 Utter, hotkey, menu bar, API, JSON, i18n, URL 같은 표준 표기를 우선한다
